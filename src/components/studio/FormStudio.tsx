...
export default function FormStudio() {
    const form = useForm<FormStudioSchema>({
        resolver: zodResolver(formStudioSchema),
        defaultValues: {
            description: '',
            area: '',
            location: '',
    ...
    const mutation = useMutation({
        ...
        onSuccess: () => {
            ...
            toast({
                ...
                description: "Studio ajouté avec succès!",
                variant: "success"
            })
            router.push('/profil')
        },
    ...
    async function onSubmit(data: FormStudioSchema) {
        const validatedFields = formStudioSchema.safeParse(data)
        ...
        mutation.mutate({
            ...
            studioNumber: propertieAdd.studioNumber,
            status: "ACTIVE",
    ...
    return (
        <div className='px-10 py-5'>
            <Form {...form}>
                <h1 className='text-2xl font-bold mb-4 text-center md:text-start'>Enregistrez un studio</h1>
                <form method='post' onSubmit={form.handleSubmit(onSubmit)}>
                    ...
                    <div className='flex flex-col space-y-4 lg:grid lg:grid-cols-2 lg:space-y-0 lg:gap-5'>
                        ...
                        <FormField
                            ...
                            render={({ field, fieldState: { error } }) => (
                                <FormItem>
                                    <FormLabel htmlFor='location'>Adresse du studio</FormLabel>
                                    <FormControl>
                                        <Input
                                            disabled={isSubmitting}
                                            type='text'
                        ...
                        <FormField
                            ...
                            render={({ field, fieldState: { error } }) => (
                                <FormItem>
                                    <FormLabel htmlFor='studioNumber'>Numéro du studio</FormLabel>
                                    <FormControl>
                                        <Input
                                            disabled={isSubmitting}
                                            type='number'
